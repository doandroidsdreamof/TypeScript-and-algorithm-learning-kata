...
console.log('false =>', containsDuplicateTwo([1, 2, 3, 4])); // false 
console.log('true =>', containsDuplicateTwo([1, 2, 3, 1])); // true
console.log('true =>', containsDuplicateTwo([1, 1, 1, 3, 3, 4, 3, 2, 4, 2])); // true
